  ...
  return (
    <div className="mx-auto flex h-full max-w-6xl flex-col px-6 py-6">
      <header className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold tracking-tight text-zinc-100">Agent Workspaces</h1>
          <p className="text-xs text-zinc-500">
            The environment that lets a self-improving loop run untrusted code — safely, and
            without cheating its way up the leaderboard.
          </p>
        </div>
